...
The login function is fake.<br/>
There is no intermediary between the customer and the data providers to pre-structure.
the processed data and hide Api keys from third services.<br/>
...
It would have allow also to manage more request by switching api services.<br/>
